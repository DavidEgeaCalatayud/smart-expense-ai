...
The consolidated `Quality gate` requires backend, frontend, dependency security, E2E and Docker jobs to pass. Financial and category benchmark workflows run as additional analysis/model gates.

...
- Documentation consistency coverage that prevents the current analysis contracts from silently drifting away from implementation.
...
- Historical-analysis documentation now treats `historical-v2.2` as the current persisted diagnostic engine.
- Actionable and historical amount-anomaly documentation now reflects the shared `merchant_mad_plus_extreme_iqr_v1` merchant-only baseline introduced by PR #42.
